...
const App: React.FC = () => {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    fetch(
      `${process.env.REACT_APP_API_PRODUCT_URL}/search?q=${encodeURIComponent(value)}`,
    )
      .then((res) => res.json())
      .then((res) => {
        if (res.search.length > 0) {
          const names = res.search
            .map((search: { name: string }) => search.name)
            .slice(0, 4);
          setChange(names);
          console.log(names);
        } else {
      ...
      <div className="app-container">
              ...
              <div className="search-wrapper">
                <form action="" className="input-group" onSubmit={handleSearch}>
                  ...
                  <div className="input-group-prepend">
                    <button
                      className="input-group-text border-none"
                      type="submit"
                    >
                ...
                <div className="suggestions">
                  <div
                    className="suggestions-wrapper px-3 pt-3 pb-1"
                    style={{
                      width: "50%",
                  ...
                  >
                    {change.length > 0 ? (
                      change.includes("search your favorite clothes") ? (
        ...
        <Switch>
          ...
          <PrivateRoute
            ...
            path={"/cart"}
            component={Cart}
            auth={{ loading: auth?.loading, avatar: auth?.avatar }}
          />
          <PrivateRoute
            exact
            path={"/pay"}
          ...
          <div className="footer-wrapper">
            <div className="footer-content">
              ...
              <p style={{ color: "#838383" }}>
                Forever is your go-to destination for trendy fashion and
                lifestyle products. We offer a wide range of high-quality
                clothing, accessories, and more, with a focus on customer
                satisfaction and fast, reliable delivery.
              </p>
            </div>
            ...
            <div className="footer-contact">
              ...
              <pre style={{ color: "#838383" }}>
                +213 0798492604 waliddari69@gmail.com
              </pre>
            </div>
          </div>
        </footer>
